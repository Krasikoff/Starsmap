# Generated by Django 4.2 on 2024-10-03 20:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competence', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rating', to='employee.competence', verbose_name='Компетенция')),
                ('skill', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rating', to='employee.skill', verbose_name='Навык')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competence', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='lastdatematch', to='employee.competence', verbose_name='Компетенция')),
                ('skill', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='lastdatematch', to='employee.skill', verbose_name='Навык')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Сотрудник')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vacancy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='employee.vacancy', verbose_name='Вакансия')),
            ],
            options={
