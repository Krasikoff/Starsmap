# Generated by Django 4.2 on 2024-10-03 15:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Администратор'), ('hr', 'HR'), ('team_chief', 'Главный в команде'), ('user', 'Пользователь')], default='user', max_length=10)),
