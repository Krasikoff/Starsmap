...
Админка настроена так,что в ней вручную (не оптимизировано) можно вести работу HR, руководителя, донастроив авторизацию.
Можно сделать красивый, функциональный фронт.

## Запуск на сервере.
Протестировано Ububntu с поддержкой docker контейнеров. Демо на сервере:
